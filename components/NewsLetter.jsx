const NewsLetter = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center text-center space-y-2 mt-24 pb-14">
            <h1 className="md:text-4xl text-2xl font-semibold">Save More Every Day!</h1>
            <p className="md:text-lg text-gray-500/70 pb-8">
                Join our family and enjoy exclusive grocery deals fresh arrivals and exciting offers.
            </p>
